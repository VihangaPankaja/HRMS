...
router.get('/get_emp_by_department_report_parameters', report.get_emp_by_dpt_report_prmts );
router.post('/create_emp_by_department_report', report.create_emp_by_dept_rprt);
...
router.get('/get_employee_supervisor_report_parameters', report.get_emp_and_supervisor_rprt_prmtrs);
router.post('/create_employee_supervisor_report', report.create_emp_and_supervisor_rprt);
